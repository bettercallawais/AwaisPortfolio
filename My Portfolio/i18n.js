...
const AR = {
  ...
  'stack.s6.story': 'البيانات النظيفة والمنمذجة هي ما تعمل عليه نماذج تعلّم الآلة وتطبيقات النماذج اللغوية فعلًا — وهنا يأتي دور شهادتي في الذكاء الاصطناعي.',
  'stack.s6.proof': 'بكالوريوس الذكاء الاصطناعي',
