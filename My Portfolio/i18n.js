...
const AR = {
  ...
  'hero.kicker': 'متاح لوظائف ذكاء الأعمال وتحليل البيانات',
  'hero.name': 'أويس علي',
  'hero.role': 'محلل ذكاء الأعمال',
  'hero.blurb': 'أبني النماذج الدلالية وخطوط معالجة البيانات ولوحات المعلومات — حاليًا في مجموعة بيكونهاوس في لاهور.',
  ...
  'meta.focK': 'التركيز',
  'meta.focV': 'النماذج الدلالية · ETL · لوحات المعلومات',
  'meta.basK': 'المقر',
  'meta.basV': 'لاهور، باكستان',

  'about.big': 'أعمل بين أنظمة البيانات المصدرية والأشخاص الذين يحتاجون إلى إجابة بحلول يوم الإثنين.',
  'about.body': 'نماذج مخطط النجمة، وDAX وSQL، ومعالجة بيانات مؤتمتة في BigQuery وPower Query — عبر قطاعات التعليم والتسويق والتجارة الإلكترونية والمالية وسلاسل الإمداد.',
  ...
  'stack.big': 'كيف تنتقل البيانات عبر أدواتي — من الملفات الخام إلى القرارات.',
  'stack.s1.name': 'الجمع',
  ...
  'stack.foundV': 'بكالوريوس الذكاء الاصطناعي — تعلّم الآلة، والإحصاء، والتنقيب في البيانات.',
  'stack.certK': 'الشهادات',

  'proj.big': 'ستة مشاريع، مع تقارير حيّة حيثما تسمح المشاركة العامة.',
  'proj.live': 'تقرير حيّ',
  ...
  'proj.p4.title': 'تحليلات سلسلة الإمداد',
  'proj.p4.sum': 'مؤشرات التسليم والخدمات اللوجستية على نموذج موحّد.',
  'proj.p4.d1': 'أبعاد موحّدة عبر الشحنات والمسارات والموردين.',
  'proj.p4.d2': 'التسليم في الموعد، ومدة الانتظار، وتكلفة الشحنة مقابل المستهدف.',
  'proj.p4.d3': 'تحسين المعالجة والاستعلامات — <b>زمن استجابة أقل بنسبة 30%</b>.',
  'proj.p5.title': 'إسناد التسويق الرقمي',
  'proj.p5.sum': 'إسناد متعدد نقاط التواصل بدلًا من آخر نقرة.',
  'proj.p5.d1': 'نمذجة الإسناد في Python وعرضها في Power BI.',
  'proj.p5.d2': 'قياس أداء القنوات بالتحويلات المُساعِدة، لا بآخر نقطة تواصل.',
  'proj.p5.d3': 'إعادة توجيه الإنفاق نحو القنوات التي تحقق التحويل فعلًا.',
  'proj.p6.title': 'أداء المبيعات والاتجاهات',
  'proj.p6.sum': 'فصل الموسمية عن الاتجاه الحقيقي، ثم أتمتة التحليل.',
  'proj.p6.d1': 'تحليل تاريخي يفصل النمط الموسمي عن الاتجاه الحقيقي.',
  'proj.p6.d2': 'سكربتات Python تعيد تشغيل التحليل وفق جدول زمني.',
  'proj.p6.d3': 'يغذّي مراقبة الأداء المستمرة، لا مجرد عرض تقديمي.',

  'contact.big': 'متاح لوظائف ذكاء الأعمال وتحليل البيانات.',
...
export const UI = {
  ...
  ar: {
    title: 'أويس علي | محلل ذكاء الأعمال',
    away: ':(',
...
const PRODUCT = /\b(Power|Looker|Microsoft|Google|Apps|SQL|Query|Data|Row-level|Kaswa|LinkedIn)\s(BI|Query|Studio|Fabric|Sheets|Script|Server|BigQuery|Folding|Modeling|Learning|security)\b/g;
